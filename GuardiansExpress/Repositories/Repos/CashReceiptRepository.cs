...
{
    public class CashReceiptRegisterRepository : ICashReceiptRepository
    {
        private readonly MyDbContext _context;

        public CashReceiptRegisterRepository(MyDbContext context)
        {
            _context = context;
        }
        ...
        public List<VoucherDto> GetCashReceiptRegisterDetails(int? branchId, string fromDate, string toDate)
        {
            var query = from voucher in _context.Vouchers
                        ...
                        where voucher.VoucherType == "Cash Receipt" // Filter only Cash Receipt vouchers
